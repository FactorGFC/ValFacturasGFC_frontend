...
import { LoginGuardGuard, AltaFacturasGuard, RolesGuard, UserOptionsGuard, VerUsuariosGuard, PrivilegiosUsuariosGuard,
         ...
         ContribuyentesFundersGuard, SolicituddeFondeoGuard, PagosafinancieraGuard, PagosafondeadorGuard, ConsultaPolizaGuard,
         GeneraPolizaGuard, CuentasContablesGuard, CobranzaDirectaGuard } from '../services/service.index';
// Generales
...
import { CobranzaDirectaComponent } from './funders/cobranzadirecta/cobranzadirecta.component'
// Contabilidad
import { CuentasContablesComponent } from './contabilidad/cuentascontables/cuentascontables.component';
import { CreaCuentaContableComponent } from './contabilidad/cuentascontables/creacuentacontable.component';
import { ActualizaCuentaContableComponent } from './contabilidad/cuentascontables/actualizacuentacontable.component';
import { GeneraPolizaComponent } from './contabilidad/generapoliza/generapoliza.component';
import { ConsultaPolizaComponent } from './contabilidad/consultapoliza/consultapoliza.component';
const pagesRoutes: Routes = [
    {
        ...
        children: [
           ...
           /* { path : 'contribuyentesfunders', component: ContribuyentesfundersComponent, data: { titulo: 'Funders' }, canActivate: [ContribuyentesFundersGuard] },
            ...
            { path : 'cobranzadirecta', component: CobranzaDirectaComponent, data: { titulo: 'Cobranza directa' }, canActivate: [CobranzaDirectaGuard] },
            // Contabilidad
            { path : 'contabilidad/cuentascontables', component: CuentasContablesComponent, data: { titulo: 'Cuentas contables' }, canActivate: [CuentasContablesGuard] },
            { path : 'contabilidad/cuentascontables/creacuentacontable', component: CreaCuentaContableComponent, data: { titulo: 'Crea cuenta contable' }, canActivate: [CuentasContablesGuard] },
            { path : 'contabilidad/cuentascontables/actualizacuentacontable/:id', component: ActualizaCuentaContableComponent, data: { titulo: 'Actualizar cuenta contable' }, canActivate: [CuentasContablesGuard] },
            { path : 'contabilidad/generapoliza', component: GeneraPolizaComponent, data: { titulo: 'Genera poliza' }, canActivate: [GeneraPolizaGuard]},
            { path : 'contabilidad/consultapoliza', component: ConsultaPolizaComponent, data: { titulo: 'Consulta poliza' }, canActivate: [ConsultaPolizaGuard]}, */
