...
generarReporte() {
  let general_report = 'NO';
  if (((document.getElementById('general_report')as HTMLInputElement).checked))
  {
  general_report = 'SI';
  }
  swal2.fire({
  ...
  this._reportesservice.getReporteDaily(fecharepor, general_report).subscribe(resp => {this.facturas = resp;
                                                                       swal2.close();
