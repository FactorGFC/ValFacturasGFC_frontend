  ...
  ngOnInit() {
    ...
    this._options.getOptionsxUsuario(localStorage.getItem('id')).subscribe( resp => {
                                                               ...
                                                               for ( const prop in resp ) {
                                                                ...
                                                                if (resp[prop].grupo === 'CONTABILIDAD') {
                                                                  this.contabilidad.titulo = 'Contabilidad';
                                                                  this.contabilidad.submenu[this.contadorcontabilidad] = { titulo: resp[prop].nombre, url: resp[prop].url };
                                                                  this.contadorcontabilidad = this.contadorcontabilidad + 1;
                                                                }
                                                              }
                                                              ...
                                                              if (this.mennu[8].titulo === 'ContabilidadNO') {
                                                                this.mennnu.push(8);
                                                              }
