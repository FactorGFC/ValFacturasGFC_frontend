  ...
  cesion_derechos_factor(conttabla, ids, folio, data) {
    ...
    doc.line(80, (tablapos + incremetotabla) + 75, 14, (tablapos + incremetotabla) + 75); // horizontal line
     ...
     /*   const file = sol;
      ...
      subirdocFactordirecto( ) {
        let idsol = '11';
        
        const params = {
          token: 'cd4bdd4fcae2dc36383bfb97742bf70d',
          secret_key: '5f34ce6c418be1693e307e4ab162b368',
          attached: 'https://firebasestorage.googleapis.com/v0/b/testfactoring-23c3f.appspot.com/o/SF1641842005%2FSF1641842005?alt=media&token=65500a9d-1596-4095-b06d-7f0ed33e99a6'
         // folio: 'SF1641842005'
      };
        this.updateSolicitudes(idsol, params).subscribe(resp => console.log(resp));
        (err) => {console.log(err)}; // this.subirurl(); });
      ...
      updateSolicitudes( ids, params ) {
        ...
        const url = `https://test.devfactorgfc.com/api/v1/requests/${ids}`;
